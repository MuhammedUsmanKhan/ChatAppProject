            ...
            <div className="bg-white p-8 rounded shadow-md w-96">
                ...
                <form>
                    <div className="mb-4">
                        ...
                        <input ref={userNamRef} type="text" id="Username" name="Username" className="w-full p-3 border rounded focus:outline-none focus:border-blue-500" placeholder="Doe" required />
                    </div>
                    <div className="mb-4">
                ...
                <div className="mt-6">
                    <p className="text-sm text-gray-600">Already have an account? <Link to={`/signin`} className="text-blue-500 hover:text-blue-600 font-semibold">Log In</Link></p>
                </div>
            </div>
        </div>
    );
